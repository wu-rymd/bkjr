...
import com.ase.restservice.ApplicationSecurity;
...
public final class AccountServiceTest {
  ...
  public void setup() {
    newAccount = new Account(userId, 100.0F, 100F, "binance");
  }
  @AfterEach
  public void cleanUp() {
  ...
  public void createAccountSuccess() throws AccountAlreadyExistsException {
    try (MockedStatic<ApplicationSecurity> mockStatic =
        Mockito.mockStatic(ApplicationSecurity.class)) {
      mockStatic.when(ApplicationSecurity::getUsernameOfClientLogged)
          .thenReturn(newAccount.getClientId());
  ...
  public void updateAccountSuccess() throws AccountNotFoundException {
    Account changedAccount = new Account(userId, newAccount.getBalance() + 10F,
        newAccount.getStartingBalance(), "binance");
